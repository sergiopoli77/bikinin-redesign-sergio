...
export default function ArtworkDetail({ artwork, packageType, setPackageType, onPlaceOrder }) {
  ...
  return (
    <div className={styles.detail}>
      ...
      {/* ── Status badge ── */}
      {/* ── Title + Stats (disembunyikan di mobile, muncul via mobileTitleBanner) ── */}
      ...
      <div className={styles.ctaRow}>
        <button
          className={`${styles.wishlistCta} ${isSaved ? styles.wishlistCtaActive : ""}`}
          id="save-wishlist-btn"
          onClick={() => setIsSaved(!isSaved)}
        ...
        <button className={styles.orderBtn} id="place-order-btn" onClick={onPlaceOrder}>
          Place Order
        </button>
      </div>
